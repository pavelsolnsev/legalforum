{% macro form(form, form_class='form_vertical', title_class='', button_class='', title='Принять участие', button='Участвовать', form_text='', add_fields, exclude_fields) %}
<form action="#" method="post" class="form {{form_class}}" onsubmit="return false" data-demo-form="{{ form }}">
