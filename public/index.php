    ...
    <div class="container">
        <div class="header__box">
            <div class="header__logo">
                <img src="img/header/logo.png" alt="Юридический форум (демо-лендинг)" class="header__logo-img">
            </div>
...
<section class="main main_top">
    ...
    <div class="container">
        ...
        <div class="main__logo">
            <img src="img/main/main_title.png" alt="Legal Forum (demo)">
        </div>
...
<form action="#" method="post" class="form form_horisontal" onsubmit="return false" data-demo-form="reg">
    ...
    <div class="container">
        ...
        <div class="concept__subtitle">
            <div class="concept__subtitle-logo">
                <img data-src="img/concept/logo_legal.png" class="lazy" alt="Legal Forum (demo)">
            </div>
...
<section class="speakers lazy" id="speakers">
		...
		<div class="row speakers__content" data-more-options='{"target":".speakers__col", "init":6, "inittablet":6, "initmobile":6, "desktop":3, "tablet":3, "mobile":2}'>
			...
			<div class="col-6 col-sm-6 col-md-4 speakers__col" data-more-hidden>
				<div href="#popup-speaker"  class="speakers__item">
					<div class="speakers__item-box">
						<div class="speakers__info">
							<div class="speakers__name">Алексей <br>Петров</div>
							<div class="speakers__post">Управляющий партнёр, юридическая компания (демо)</div>
						</div>
						
						<div class="speakers__photo">
							<img data-src="img/speakers/card/lemchik.jpg" alt="Алексей Петров" class="lazy">
						</div>
			...
			<div class="col-6 col-sm-6 col-md-4 speakers__col" data-more-hidden>
				<div href="#popup-speaker"  class="speakers__item">
					<div class="speakers__item-box">
						<div class="speakers__info">
							<div class="speakers__name">Дмитрий <br>Сидоров</div>
							<div class="speakers__post">Управляющий партнёр, юридическая компания (демо)</div>
						</div>
						
						<div class="speakers__photo">
							<img data-src="img/speakers/card/krupskiy.jpg" alt="Дмитрий Сидоров" class="lazy">
						</div>
	...
	<div class="container">
		...
		<table class="program__teble">
			...
			<tr>
				<td>Алексей Петров <br>(модератор)</td>
			...
			<tr>
				<td>Дмитрий Сидоров <br>(модератор)</td>
		...
		<div class="program__mobile">
			...
			<div class="program__mobile-card">
				...
				<ul class="program__mobile-card_speakers">
					<li>Алексей Петров <br>(модератор)</li>
			...
			<div class="program__mobile-card">
				...
				<ul class="program__mobile-card_speakers">
					<li>Дмитрий Сидоров (модератор)</li>
    ...
    <div class="location__box">
        <div class="location__info">
            ...
            <div class="location__name">ПЛОЩАДКА <br>(ДЕМО)</div>
            <div class="location__description">Демо-описание площадки для портфолио: конференц-зал в деловом центре, удобная транспортная доступность. Конкретный отель и адрес намеренно не указаны.</div>
        </div>
        <div class="location__photo">
            <img data-src="img/location/hotel.jpg" class="lazy" alt="Площадка проведения (демо)">
        </div>
    </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="platform__item">
                            ...
                            <p class="platform__item-text">БАЗА ЗНАНИЙ С&nbsp;ЛУЧШИМИ ВИДЕО С&nbsp;ОТРАСЛЕВЫХ МЕРОПРИЯТИЙ (ДЕМО)</p>
                        </div>
                    </div>
        ...
        <div class="organizer__content">
            <div class="organizer__content-left">
                ...
                <div class="organizer__logo">
                    <img data-src="img/organizer/logo_synergy.png" class="lazy" alt="Организатор (демо)">
                </div>
            </div>
            <div class="organizer__content-right">Демо-текст: образовательная организация, проводящая отраслевые мероприятия и программы для предпринимателей. Описание и брендинг заменены для публикации в портфолио.</div>
        </div>
        ...
        <div class="organizer__second">
            <div class="organizer__second-head">
                ...
                <div class="organizer__second-logo">
                    <img data-src="img/organizer/logo_lkp.png" class="lazy" alt="Соорганизатор (демо)">
                </div>
            </div>
            <div class="organizer__second-text">Демо-текст: юридическая практика&nbsp;&mdash; сопровождение бизнеса, налоговый и корпоративный консалтинг. Название и детали заменены для демонстрации вёрстки.</div>
        </div>
    ...
    <div class="container">
        <div class="vtb__box">
                <div class="vtb__logo">
                    <img src="img/vtb/logo_vtb.png" alt="Партнёрский блок (демо)" class="lazy">
                </div>
                <div class="vtb__title">Демо: специальное предложение для бизнеса</div>
                <ul class="vtb__list">
                    <li class="vtb__list-item">Условия и сроки&nbsp;&mdash; <span class="vtb__list-item-part">пример вёрстки</span></li>
                    <li class="vtb__list-item">Текст заменён на нейтральный для портфолио</li>
                    <li class="vtb__list-item">Реальные офферы и банки здесь не рекламируются</li>
                </ul>
                <div class="vtb__subtitle">Сервисы (плейсхолдер):</div>
                <ul class="vtb__list">
                    <li class="vtb__list-item">Бухгалтерия и отчётность</li>
                    <li class="vtb__list-item">Обучение для предпринимателей</li>
                    <li class="vtb__list-item">Регистрация бизнеса онлайн</li>
                </ul>
                <div class="vtb__buttonbox">
                    <a href="https://example.com/demo/partner-offer/" class="button button_link vtb__button" target="_blank" rel="noopener noreferrer">Подробнее (демо)</a>
                </div>
        </div>
    </div>
</section><!-- vtb -->
    ...
    <div class="container">
        ...
        <div class="gallerey_block">
            <a href="#" class="gallerey-video" onclick="return false" aria-label="Видео (демо, без источника)">
...
<form action="#" method="post" class="form form_vertical" onsubmit="return false" data-demo-form="reg">
    <div class="form__wrapper">
...
<div class="popup popup-partner" id="popup-partner">
    <div class="popup-partner__block">
        ...
        <p class="subtitle"><a href="mailto:media@example.com">media@example.com</a></p>
